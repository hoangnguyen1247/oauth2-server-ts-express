...
describe('ExpressOAuthServer', function () {
    ...
    describe('constructor()', function () {
        it('should throw an error if `model` is missing', function () {
            try {
                ...
                e.should.be.an.instanceOf(oauth2_server_ts_1.InvalidArgumentError);
                e.message.should.equal('Missing parameter: `model`');
            }
        });
        it('should set the `server`', function () {
            var oauth = new __1.default({ model: {} });
            oauth.server.should.be.an.instanceOf(oauth2_server_ts_1.OAuth2Server);
        });
    });
    describe('authenticate()', function () {
        ...
        it('should authenticate the request', function (done) {
            ...
            var oauth = new __1.default({ model: model });
            app.use(oauth.authenticate());
    ...
    describe('authorize()', function () {
        it('should cache the authorization code', function (done) {
            ...
            var oauth = new __1.default({ model: model, continueMiddleware: true });
