...
describe('ExpressOAuthServer', function () {
    ...
    describe('authenticate()', function () {
        it('should call `authenticate()`', function (done) {
            var oauth = new __1.default({ model: {} });
            ...
            request(app.listen())
                ...
                oauth.server.authenticate.firstCall.args[0].should.be.an.instanceOf(oauth2_server_ts_1.Request);
                oauth.server.authenticate.firstCall.args[1].should.be.an.instanceOf(oauth2_server_ts_1.Response);
    ...
    describe('authorize()', function () {
        it('should call `authorize()` and end middleware execution', function (done) {
            ...
            request(app.listen())
                ...
                oauth.server.authorize.firstCall.args[0].should.be.an.instanceOf(oauth2_server_ts_1.Request);
                oauth.server.authorize.firstCall.args[1].should.be.an.instanceOf(oauth2_server_ts_1.Response);
        ...
        it('should call `authorize()` and continue middleware chain', function (done) {
            var nextMiddleware = sinon.spy();
            var oauth = new __1.default({ model: {}, continueMiddleware: true });
            sinon.stub(oauth.server, 'authorize').returns({});
            app.use(oauth.authorize());
            app.use(nextMiddleware);
            request(app.listen())
    ...
    describe('token()', function () {
        it('should call `token()` and end middleware chain', function (done) {
            ...
            request(app.listen())
                ...
                oauth.server.token.firstCall.args[0].should.be.an.instanceOf(oauth2_server_ts_1.Request);
                oauth.server.token.firstCall.args[1].should.be.an.instanceOf(oauth2_server_ts_1.Response);
